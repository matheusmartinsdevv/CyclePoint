...
$stmt = $conn->prepare("SELECT id_equipamento, nome_equipamento, fabricante, modelo, vida_util_meses FROM equipamento WHERE id_empresa = ? AND status_equipamento IS NULL");$stmt->bind_param("i", $id_empresa);
$stmt->execute();
