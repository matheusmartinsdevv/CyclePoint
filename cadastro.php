...
<body class="cadastro-body">
    ...
    <div class="auth-container large-container">
        ...
        <!-- CADASTRO DE EMPRESA COMUM -->
        <form id="form-empresa-comum" action="./app/php/cadastroEmpresa.php" method="POST"
            class="registration-form active">
            <h3>Dados da Empresa Comum</h3>

            <div class="form-grid">
                <div class="input-group"><label>Razão Social*</label><input type="text" name="razao_social" required>
                </div>
                <div class="input-group"><label>Nome Fantasia*</label><input type="text" name="nome_fantasia" required>
                </div>
                <div class="input-group"><label>CNPJ*</label><input type="text" name="cnpj" maxlength="18" required>
                </div>
            ...
            <div class="form-grid">
                ...
                <div class="input-group"><label>Defina a Senha*</label><input type="password" name="senha" required>
                </div>
            </div>
            <hr>
            ...
            <div class="form-grid address-grid">
                ...
                <div class="input-group"><input type="text" placeholder="Nº" name="numero" required class="input-small">
                </div>
        ...
        <form id="form-recicladora" action="./app/php/cadastroRecicladora.php" method="POST" class="registration-form">
            ...
            <div class="form-grid address-grid">
                <div class="input-group"><input type="text" placeholder="Logradouro" name="logradouro" required></div>
                <div class="input-group"><input type="number" placeholder="Nº" name="numero" required
                        class="input-small"></div>
                <div class="input-group"><input type="text" placeholder="Bairro" name="bairro"></div>
                <div class="input-group"><input type="text" placeholder="Cidade" name="cidade" required></div>
                <div class="input-group"><input type="text" placeholder="Estado" name="estado" required></div>
                <div class="input-group"><input type="text" placeholder="País" name="pais" value="Brasil" required>
        ...
        <a href="login.php" class="forgot-link">Já tem cadastro? Voltar para o Login.</a>
    </div>
